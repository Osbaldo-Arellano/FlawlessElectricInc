export const brandConfig = {
  ...
  ui: {
    ...
    dashboard: {
      ...
      subtitle: "Manage your company branding and generate marketing materials",
    ...
    companyInfo: {
      ...
      subtitle: "Update your company name and logo",
      ...
      logoHint: "PNG, JPG, or SVG. Recommended size: 512x512px",
      noLogo: "No logo",
      autoSaveNote: "Changes are automatically saved and will reflect across the landing page and all generated materials.",
    },

    preview: {
      title: "Preview",
      subtitle: "How your brand will appear on materials",
    },

    businessCards: {
      title: "Business Cards",
      subtitle: "Generate print-ready business card HTML from templates",
      selectTemplate: "Click a template to customize and download as HTML",
      modernMinimal: "Modern Minimal",
      modernMinimalDesc: "Clean lines, subtle accent",
      boldCorporate: "Bold Corporate",
      boldCorporateDesc: "Strong accent bar, centered",
      comingSoon: "More templates coming soon",
      comingSoonDesc: "Letterheads, email signatures, social media assets, and more",
    },

    cardEditor: {
      customize: "Customize your business card and download as HTML",
      ...
      taglineBack: "Tagline (Back)",
      taglinePlaceholder: "Company tagline",
      reset: "Reset",
      preview: "Preview",
      front: "Front",
      back: "Back",
