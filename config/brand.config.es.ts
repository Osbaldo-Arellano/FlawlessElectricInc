export const brandConfig = {
  ...
  ui: {
    ...
    dashboard: {
      ...
      subtitle: "Administra tu marca y genera materiales de marketing",
    ...
    companyInfo: {
      ...
      subtitle: "Actualiza el nombre y logo de tu empresa",
      ...
      logoHint: "PNG, JPG o SVG. Tama\u00f1o recomendado: 512x512px",
      noLogo: "Sin logo",
      autoSaveNote: "Los cambios se guardan autom\u00e1ticamente y se reflejar\u00e1n en la p\u00e1gina principal y todos los materiales generados.",
    },

    preview: {
      title: "Vista Previa",
      subtitle: "C\u00f3mo aparecer\u00e1 tu marca en los materiales",
    },

    businessCards: {
      title: "Tarjetas de Presentaci\u00f3n",
      subtitle: "Genera tarjetas de presentaci\u00f3n en HTML listas para imprimir",
      selectTemplate: "Haz clic en una plantilla para personalizar y descargar como HTML",
      modernMinimal: "Moderno Minimalista",
      modernMinimalDesc: "L\u00edneas limpias, acento sutil",
      boldCorporate: "Corporativo Audaz",
      boldCorporateDesc: "Barra de acento fuerte, centrado",
      comingSoon: "M\u00e1s plantillas pr\u00f3ximamente",
      comingSoonDesc: "Membretes, firmas de correo, activos para redes sociales y m\u00e1s",
    },

    cardEditor: {
      customize: "Personaliza tu tarjeta de presentaci\u00f3n y desc\u00e1rgala como HTML",
      ...
      taglineBack: "Eslogan (Reverso)",
      taglinePlaceholder: "Eslogan de la empresa",
      reset: "Restablecer",
    ...
    loginPage: {
      ...
      signUp: "Reg\u00edstrate",
      devBypass: "Acceso de desarrollo",
      skipToDashboard: "Ir al Panel",
    },
  },
} as const;
