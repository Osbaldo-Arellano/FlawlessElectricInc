...
export function GallerySwitcher() {
  ...
  const hasVideos = brand.gallery.videos.length > 0;
          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-6">
            {brand.gallery.items.map((item, index) => (
              <AnimateOnScroll key={index} animation="fade-up" delay={index * 75}>
                <div className="group relative overflow-hidden rounded-lg bg-background border border-border/50 hover:border-primary/50 transition-colors">
